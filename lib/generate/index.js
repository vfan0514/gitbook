...
var generate = function(options) {
    ...
    // Read readme
    .then(function() {
        var introductionFilePath = (options.introduction !== undefined ? options.introduction.path : "README.md")
        return fs.readFile(path.join(options.input, introductionFilePath), "utf-8")
...
var generateBook = function(options) {
    ...
    return containsFiles(options.input, ['SUMMARY.md'])

    // Fail if not a book
    .then(function(isBook) {
        if(!isBook) {
            return Q.reject(new Error("Invalid gitbook repository, need SUMMARY.md"));
        }
    })
    ...
    .then(function(generator) {
        ...
        .then(function() {
            ...
            return fs.readFile(summary.path, "utf-8")
                ...
                .then(function() {
                    summary.content = parse.summary(summary.content, options);
